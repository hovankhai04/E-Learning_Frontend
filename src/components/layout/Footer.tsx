...
export const Footer = () => {
    return (
        <>
            <footer className="bg-white text-gray-15 py-4 fixed bottom-0 w-full ">
                <div className="container mx-auto px-8">
                    <div className="flex flex-col md:flex-row justify-around items-center border-b border-gray-200 pb-6 mx-auto">
                        ...
                        <div className=" px-4 mx-8 flex justify-start items-start flex-col space-y-6">
                            ...
                            <a href="https://www.facebook.com/enclaveit" className="flex justify-center items-center hover:bg-gray-300 w-8 h-8 rounded-sm border border-gray-300"  target="blank"><FaFacebook className="inline w-6 h-6 text-blue-600" /></a>
                            <a href="https://www.enclave.vn" className="flex justify-center items-center hover:bg-gray-300 w-8 h-8 rounded-sm border border-gray-300" target="blank"><RiGlobalLine className="inline w-6 h-6" /></a>
                            <a href="https://www.linkedin.com/company/enclave.vietnam" className="flex justify-center items-center hover:bg-gray-300 w-8 h-8 rounded-sm border border-gray-300" target="blank"><FaLinkedin className="inline w-6 h-6 text-blue-800" /></a>
                            </div>
